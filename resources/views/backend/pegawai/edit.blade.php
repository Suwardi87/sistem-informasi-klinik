...
<div id="main">
    ...
    <div class="py-4">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a
                        href="{{ route('backend.pegawai.edit', $pegawai->uuid) }}">@yield('title')</a></li>
                </ol>
        </nav>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('backend.pegawai.update', $pegawai->uuid) }}" method="POST" id="formUpdatePegawai">
                @csrf
                @method('PUT')
                <input type="hidden" id="uuid" value="{{ $pegawai->uuid }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                name="jabatan" value="{{ old('jabatan', $pegawai->jabatan) }}" required>
                            @error('jabatan')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text"
                                ...
                                name="telepon" value="{{ old('telepon', $pegawai->telepon) }}" required>
                            @error('telepon')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
